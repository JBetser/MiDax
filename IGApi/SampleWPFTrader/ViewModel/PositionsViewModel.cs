...
namespace SampleWPFTrader.ViewModel
{
    ...
    /// 
    /// PositionsViewModel : This file handles all the business logic for the positions. i.e. requesting static data from rest for the 
    /// positions, then subscribing to live positions data from Lightstreamer.
    ///
    ...
    {               
        ...
        private string _positionDebugData;
        public string PositionDebugData
        {
            get { return _positionDebugData; }
            set
            {
                if ((_positionDebugData != value) && (value != null))
                {
                    _positionDebugData = value;
                    RaisePropertyChanged("PositionDebugData");
                }
            }
        }
        ...
        {
            PositionDebugData += message + Environment.NewLine;
        }      
