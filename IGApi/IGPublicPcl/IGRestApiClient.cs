...
using dto.endpoint.auth.silentlogin;
...
using dto.endpoint.funds.deposit;
using dto.endpoint.funds.deposit.authorise3d;
using dto.endpoint.funds.deposit.surcharge;
using dto.endpoint.funds.manage.add;
using dto.endpoint.funds.manage.edit;
using dto.endpoint.funds.manage.delete;
using dto.endpoint.funds.manage.retrieve;
using dto.endpoint.funds.manage.transfer;
using dto.endpoint.funds.manage.type;
using dto.endpoint.funds.withdraw;
using dto.endpoint.marketdetails.v2;
using dto.endpoint.marketdetails.v1;
...
using dto.endpoint.positions.get.sprintmarkets.v1;
...
namespace IGPublicPcl
{
   ...
   /// </Summary>
	...
	public partial class IgRestApiClient
	{
		...
		public async Task<IgResponse<dto.endpoint.auth.session.AuthenticationResponse>> authenticate(dto.endpoint.auth.session.AuthenticationRequest authenticationRequest) 
		{
